...
// Beijing Location Markers
    ...
    ["<h3 class=info-window-styling>The Imperial Palace & The Foribdden City</h3>  <a class=info-window-link target=_blank href=https://en.dpm.org.cn>The Palace Exhibitions Website</a> <p class=info-window-p> 4 Jingshan Front St, Dongcheng, Beijing, China, 100009 </P> <button class=info-window-button onclick=choosePlace('theImperialPalaceAndTheForbiddenCity')>Find Out More</button>", 39.9169, 116.3907, "attractions"],
    ...
    ["<h3 class=info-window-styling>Qing-Feng Steamed Dumpling</h3>  <a class=info-window-link target=_blank href=https://www.tripadvisor.co.uk/Restaurant_Review-g294212-d8489213-Reviews-Qingfeng_Steamed_Dumpling_Shop_Dengshikou-Beijing.html>Trip Advisor Reviews</a> <p class=info-window-p> Dongdan N St, Wangfujing, Dongcheng, Beijing, China </P> <button class=info-window-button onclick=choosePlace('qingFengSteamedDumplingShop')>Find Out More</button>", 39.5527, 116.2320, "restaurants"], 
    ["<h3 class=info-window-styling>Qianmen Quanjude</h3>  <a class=info-window-link target=_blank href=https://www.quanjude.com.cn>Website</a> <p class=info-window-p> 30 Qianmen St, Dongcheng, Beijing, China </P> <button class=info-window-button onclick=choosePlace('qianmenQuanjude')>Find Out More</button>", 39.89653417557819, 116.3982514674211, "restaurants"],
    ["<h3 class=info-window-styling>Yuebin Restaurant</h3>  <a class=info-window-link target=_blank href=https://www.tripadvisor.co.uk/Restaurant_Review-g294212-d4446565-Reviews-Yue_Bin_Restaurant-Beijing.html>Reviews</a> <p class=info-window-p>China, Beijing, Dongcheng, 翠花胡同43号</P> <button class=info-window-button onclick=choosePlace('yuebinRestaurant')>Find Out More</button>", 39.924021881841234, 116.40745635384228, "restaurants"],
    ["<h3 class=info-window-styling>Beihai Park</h3>  <a class=info-window-link target=_blank href=https://www.travelchinaguide.com/attraction/beijing/beihai.htm>Travel China Guide</a> <p class=info-window-p> 1 Wenjin St, Xicheng District, China, 100034 </P> <button class=info-window-button onclick=choosePlace('beihaiPark')>Find Out More</button>", 39.92562016157413, 116.38929608452374, "parks"],
    ["<h3 class=info-window-styling>Tiananmen Square</h3>  <a class=info-window-link target=_blank href=https://www.tripadvisor.co.uk/Attraction_Review-g294212-d311533-Reviews-Tiananmen_Square_Tiananmen_Guangchang-Beijing.html>Trip Advisor Reviews</a> <p class=info-window-p> Dongcheng, China </P> <button class=info-window-button onclick=choosePlace('tiananmenSquare')>Find Out More</button>", 39.9254, 116.3893, "parks"],
    ["<h3 class=info-window-styling>Jingshan Park</h3>  <a class=info-window-link target=_blank href=https://www.travelchinaguide.com/attraction/beijing/jingshan.htm>Travel China Guide</a> <p class=info-window-p> 44 Jingshan W St, Xicheng District, Beijing, China, 100009 </P> <button class=info-window-button onclick=choosePlace('jingshanPark')>Find Out More</button>", 39.5525, 116.2326, "parks"],
...
// Hong Kong Location Markers
    ["<h3 class=info-window-styling>Victoria Peak</h3>  <a class=info-window-link target=_blank href=https://www.hk-victoria-peak.com>Website</a> <p class=info-window-p> No.1 Lugard Road, Hong Kong China </P> <button class=info-window-button onclick=choosePlace('victoriaPeak')>Find Out More</button>", 22.2759, 114.1455, "attractions"],
    ["<h3 class=info-window-styling>Star Ferry</h3>  <a class=info-window-link target=_blank href=http://www.starferry.com.hk/en/Fares>Website</a> <p class=info-window-p> Kowloon Point, Tsim Sha Tsui, Kowloon, Hong Kong China </P> <button class=info-window-button onclick=choosePlace('starFerry')>Find Out More</button>", 22.2857, 114.1567, "attractions"],
    ...
    ["<h3 class=info-window-styling>Arbor</h3>  <a class=info-window-link target=_blank href=http://arbor-hk.com/concept.html>Website</a> <p class=info-window-p> Hong Kong, Central, Queen's Road Central, 80號HK 香港島H Queen's 25 </P> <button class=info-window-button onclick=choosePlace('arbor')>Find Out More</button>", 22.28322, 114.15535, "restaurants"],
    ["<h3 class=info-window-styling>The Chairman</h3>  <a class=info-window-link target=_blank href=http://www.thechairmangroup.com>Website</a> <p class=info-window-p> 18號 Kau U Fong, Central, Hong Kong </P> <button class=info-window-button onclick=choosePlace('theChairman')>Find Out More</button>", 22.284580, 114.152672, "restaurants"],
    ["<h3 class=info-window-styling>Ocean Park</h3>  <a class=info-window-link target=_blank href=https://www.oceanpark.com.hk/en>Website</a> <p class=info-window-p> No.180 Wong Chuk Hang Road, Aberdeen, Hong Kong China </P> <button class=info-window-button onclick=choosePlace('oceanPark')>Find Out More</button>", 22.2467, 114.1757, "parks"],
    ["<h3 class=info-window-styling>Hong Kong Park</h3>  <a class=info-window-link target=_blank href=https://www.lcsd.gov.hk/en/parks/hkp/>Website</a> <p class=info-window-p> 19 Cotton Tree Dr, Central, Hong Kong China</P> <button class=info-window-button onclick=choosePlace('hongKongPark')>Find Out More</button>", 22.2765, 114.1596, "parks"],
    ["<h3 class=info-window-styling>Chi Lin Nunnery and Nan</h3>  <a class=info-window-link target=_blank href=http://www.chilin.org>Website</a> <p class=info-window-p> Chi Lin Rd, Diamond Hill, Hong Kong China </P> <button class=info-window-button onclick=choosePlace('chiLinNunneryAndNanLianGarden')>Find Out More</button>", 22.3404, 114.2055, "parks"],
    ["<h3 class=info-window-styling>Hong Kong Skyline</h3>  <a class=info-window-link target=_blank href=https://www.tripadvisor.co.uk/Attraction_Review-g294217-d2482919-Reviews-Hong_Kong_Skyline-Hong_Kong.html>Trip Advisor Reviews</a> <p class=info-window-p> Hong Kong Island, along Victoria Harbor, Hong Kong China </P> <button class=info-window-button onclick=choosePlace('hongKongSkyline')>Find Out More</button>", 22.2855, 114.1577, "parks"]
];
// Icons
var cityIcon = L.icon({
